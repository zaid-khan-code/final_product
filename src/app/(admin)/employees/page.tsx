  ...
  return (
    <div>
      <div className="pg-head">
        ...
        <button className="btn btn-primary" onClick={() => router.push('/employees/add')}><Plus size={13} /> Add Employee</button>
      </div>
                ...
                <tr key={e.id} style={{ ...(selected.has(e.id) ? { background: 'var(--pl)' } : {}), ...(e.jobStatus === 'Terminated' ? { opacity: 0.5 } : {}) }}>
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: 4 }}>
                      <button className="ico-btn" style={{ width: 28, height: 28 }} onClick={() => router.push(`/employees/${e.id}`)}><Eye size={13} /></button>
                      <button className="ico-btn" style={{ width: 28, height: 28 }} onClick={() => router.push('/employees/add')}><Pencil size={13} /></button>
                    </div>
                  </td>
                </tr>
              ))}
