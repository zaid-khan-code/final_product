  ...
  return (
    <div>
      ...
      <Modal open={genModal} onClose={() => setGenModal(false)} title="Generate Payroll — March 2026" wide footer={
        <><button className="btn btn-secondary" onClick={() => savePayroll('Draft')} disabled={saving}>Save as Draft</button>
        <button className="btn btn-primary" onClick={() => savePayroll('Finalized')} disabled={saving}>Finalize & Lock</button></>
      }>
