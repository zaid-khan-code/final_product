...
export default function AdminLayoutWrapper({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && sessionStorage.getItem('ems_banner_dismissed') === 'true') setBannerDismissed(true);
  }, []);
  ...
  const handleDismiss = () => {
    ...
    if (typeof window !== 'undefined') sessionStorage.setItem('ems_banner_dismissed', 'true');
  };
